    ...
    <>
      ...
      <div className="mx-auto my-10 w-full space-y-5 rounded-xl bg-white p-5 shadow-md dark:bg-gray-900 md:max-w-3xl md:p-6">
        ...
        <div className="space-y-3 pb-2">
          <h1 className="sm:text-2.5xl text-2xl font-black dark:text-white">
            Subscribe to Newsletter!
          </h1>
          <p className="text-gray-600 dark:text-gray-300">
            Receive notifications of high-quality articles about
            frontend development and other relevant topics delivered
            straight to your inbox. You will receive a monthly email
            from me, ensuring a spam-free experience.
          </p>
        </div>
        ...
        <Formik
          ...
          onSubmit={async (values, { resetForm }) => {
            ...
            try {
              ...
              setStatus(201);
              setMessage(
                "Thank you for subscribing my newsletter 👻."
              );
